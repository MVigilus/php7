        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li class="">
                        <a class="page-scroll" href="#services">visualizza prodotti</a>
                    </li>
                    <li class="">
                        <a class="page-scroll" href="#inserisci.html">aggiungi prodotto</a>
                    </li>
                    <li class="">
                        <a class="page-scroll" href="#services">elimina prodotto</a>
                    </li>
                    <li class="" >
            ...
            <table class="table">
                ...
                <tbody>
                  ...
                  while($row = mysqli_fetch_array($result))
                  {
                      ...
                      echo "<td>".$row['qta']."</td> \n";
                      echo "<td> <a href='cancella.php?par1=$row[idProdotti]'>cancella prodotto</a></td>";
                      echo "</tr> \n";
                  }
                  ?>
                </tbody>
              </table>
              <form action="inserisci.html">
